...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="titleQueBg">
    <tr>
        <form name="form1" method="get" action="" id="form1">
            ...
            {{--<a class="button" href="{{url('statistics/daily')}}">所有渠道</a>--}}
            {{--<a class="button" href="{{url('statistics/daily')}}?pack_name=1">渠道1</a>--}}
            {{--<a class="button" href="{{url('statistics/daily')}}?pack_name=2">渠道2</a>--}}
            {{--<a class="button" href="{{url('statistics/daily')}}?pack_name=3">渠道3</a>--}}
            {{--<a class="button" href="{{url('statistics/daily')}}?pack_name=4">渠道4</a>--}}
            {{--<a class="button" href="{{url('statistics/daily')}}?pack_name=5">渠道5</a>--}}
            {{--<a class="button" href="{{url('statistics/daily')}}?pack_name=6">渠道6</a>--}}
            {{--</td>--}}
        </form>
    </tr>
</table>
