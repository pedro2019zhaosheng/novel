...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="titleQueBg">
    <tr>
        <form name="form1" method="get" action="{{url('statistics/newkeep')}}" id="form1">
...
<div id="content">
    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="box num" id="list" style="display: none;">
        <tr align="center" class="bold">
            ...
            @foreach($datas as $data)
                <tr align="center" @if($i++%2==0) class="list" @else class="listBg"
                    ...
                    <td>{{$data['day']}}</td>
                    <td>{{$data['today_num']}}</td>
                    <td>{{$data['onelater_num']}}</td>
                    <td>{{$data['twolater_num']}}</td>
                    <td>{{$data['threelater_num']}}</td>
                    <td>{{$data['fourlater_num']}}</td>
                    <td>{{$data['fivelater_num']}}</td>
                    <td>{{$data['sixlater_num']}}</td>
                    <td>{{$data['senvenlater_num']}}</td>
                    <td>{{$data['fourteenlater_num']}}</td>
                    <td>{{$data['thritylater_num']}}</td>
                </tr>
