...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="titleQueBg">
    <tr>
        <form name="form1" method="get" action="{{url('statistics/uvpv')}}" id="form1">
...
<div id="content">
    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="box" id="list">
        <tr align="center" class="bold">
            ...
            <td class="listTitle">UV</td>
            <td class="listTitle">PV</td>
            <td class="listTitle">平均PV</td>
...
<script type="text/javascript">
    $(function () {
        ...
        myChart.setOption({
            ...
            series: [
                {
                    data: <?php echo $uvyAxis;?>,
                    name: 'UV',
                    type: 'line'
                },
                {
                    data: <?php echo $pvyAxis;?>,
                    name: 'PV',
                    type: 'line'
                },
