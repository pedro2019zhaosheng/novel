...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="titleQueBg">
    <tr>
        <form name="form1" method="get" action="{{url('statistics/history')}}" id="form1">
...
<div id="content">
    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="box" id="list">
        <tr align="center" class="bold">
            ...
            <td class="listTitle">点击总次数</td>


        </tr>
        <?php $i = 1;?>
        @foreach($datas as $data)
            <?php if(!empty($data['al'])){ ?>
    ...
    $(function () {
        ...
        myChart.setOption({
            ...
            legend: {
                ...
                right: "5%",
                data: ['打开总次数','IOS打开次数','Android打开次数']
            },
            tooltip: {
                trigger: 'axis',
                axisPointer: {
