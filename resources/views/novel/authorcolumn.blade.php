        ...
        @foreach($novel_banners as $novel_banner)
            <tr align="center" @if($i++%2==0) class="list" @else class="listBg"
                ...
                <td>
                    ...
                    <button class="myEdit wd1" id="{{$novel_banner->id}}" link="{{$novel_banner->link}}" img="{{$novel_banner->img}}" sort="{{$novel_banner->sort}}">编辑</button>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabelEdit">编辑作者</h4>
            </div>
            <div class="modal-body">
                <form id="thisEditPro" class="form-horizontal" method="post"
                      action="{{url('novel/edit-author')}}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label for="inputEmail3" class="col-sm-3 control-label">作者</label>
                        <div class="col-sm-4">
                            <input type="text" id="elink" class="form-control" name="author" value="" placeholder="作者" required="required">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label">作者图片</label>
                        <div class="col-sm-8">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                            aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="myModalLabelEdit">新增作者</h4>
            </div>
            <div class="modal-body">
                <form id="thisEditPro" class="form-horizontal" method="post"
                      action="{{url('novel/add-author')}}" enctype="multipart/form-data">

                    <div class="form-group">
                        <label for="inputEmail3" class="col-sm-3 control-label">作者</label>
                        <div class="col-sm-4">
                            <input type="text"  class="form-control" name="author" value="" placeholder="作者" required="required">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="inputEmail3" class="col-sm-3 control-label">排序</label>
