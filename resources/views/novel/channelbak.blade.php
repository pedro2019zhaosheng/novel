                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8" id="kindlist">
                            @foreach($categorys as $category)
                                <div><input name="ecateid" value="{{$category->cateid}}" kindname="{{$category->name}}" type="checkbox">{{$category->name }}</div>
                            @endforeach
            ...
            <div class="modal-body">
                <div class="form-horizontal" >
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            @foreach($categorys as $category)
                                <div><input name="cateid" value="{{$category->cateid}}" kindname="{{$category->name}}" type="checkbox">{{$category->name }}</div>
                            @endforeach
