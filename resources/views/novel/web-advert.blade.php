    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="box" id="list">
        ...
        @foreach($adverts as $advert)
            <tr align="center" @if($i++%2==0) class="list" @else class="listBg"
                ...
                <td>
                    @if ($advert->type == 1) 底部 @elseif ($advert->type == 2) 侧边 @endif
                </td>
                <td>
                ...
                <td>
                    <button class="myEdit wd1" adver_type='{{$advert->adver_type}}' mytype="{{$advert->type}}" platform="{{$advert->platform}}" start="{{date('Y-m-d H:i:s', $advert->start)}}" end="{{date('Y-m-d H:i:s', $advert->end)}}" status="{{$advert->status}}" url="{{$advert->url}}" advertid="{{$advert->advertid}}" title="{{$advert->title}}" sort="{{$advert->sort}}" img="{{$advert->img}}">编辑</button>
                </td>
            </tr>
        @endforeach
    </table>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="thisEditPro" class="form-horizontal" method="post"
                      action="{{url('novel/edit-web-advert')}}"  enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                        <input type="text" class="form-control" name="platform" value="" placeholder="广告平台">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="url" value="" placeholder="广告跳转连接">
                        </div>
                    </div>
                     <div class="form-group">
...
<div class="modal fade" id="myModalAdd" tabindex="-1" role="dialog" aria-labelledby="myModalLabelEdit">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="thisEditPro" class="form-horizontal" method="post"
                      action="{{url('novel/add-web-advert')}}"  enctype="multipart/form-data">
                    <div class="form-group">
                        <label for="inputEmail3" class="col-sm-3 control-label">广告名称</label>
                        <div class="col-sm-4">
                            <input type="text" class="form-control" name="title" value="" placeholder="广告名称">
...
$('.myEdit').click(function () {
    ...
    $('#myModalEdit input[name=platform]').val($(this).attr('platform'));
