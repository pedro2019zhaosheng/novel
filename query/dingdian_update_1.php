...
$sql = "SELECT a.novelid,a.sourceid,a.name,a.author,a.chapter,b.url FROM novel as a LEFT JOIN novel_status as b ON a.novelid = b.novelid WHERE a.sourceid = {$sourceid}";
$result = mysqli_query($conn, $sql);
$array = $result->fetch_all();

foreach ($array as $i => $value) {
    $i = $i + 1;
    if (!$value[5] or $value[4] > 0 or $value[0] < 50000) {
        continue;
    }
    ...
    $chapter_t = 'chapter_dingdian' . intval($i / 1000);
